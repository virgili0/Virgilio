...
As usual the structure I've planned to get you started consists of having a [general overview] first(https://en.wikipedia.org/wiki/Data_preparation), and then dive deep into each data processing situation you can encounter. 
